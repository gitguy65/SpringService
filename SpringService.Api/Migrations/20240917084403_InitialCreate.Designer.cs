...
namespace SpringService.Api.Migrations
{
    ...
    [Migration("20240917084403_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SpringService.Api.Models.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SpringService.Api.Models.Schedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SpringService.Api.Models.Service", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SpringService.Api.Models.UserProfile", b =>
                {
            ...
            modelBuilder.Entity("SpringService.Api.Models.Booking", b =>
                {
                    b.HasOne("SpringService.Api.Models.UserProfile", "UserProfile")
                        .WithMany("Bookings")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SpringService.Api.Models.Review", b =>
                {
                    b.HasOne("SpringService.Api.Models.UserProfile", "ServiceProvider")
                        .WithMany("ReceivedReviews")
                        .HasForeignKey("ServiceProviderId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SpringService.Api.Models.UserProfile", "ServiceUser")
