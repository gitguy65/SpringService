...
namespace SpringService.Api.Util
{
    ...
    public static class SeedRoutesExtensions
    {
        ...
        {
            endpoints.MapPost("/seed-tables{pass}", async (
                int pass, [FromServices]ApplicationDbContext db, 
                [FromServices] UserManager<UserProfile> userManager) =>
            {
                if(pass != 12345)
                    return Results.Problem("Incorrect password", statusCode: 400);
                ...
                try
                {
                    ...
                    //  db.UserProfiles.ExecuteDeleteAsync();
                    ...
                    var userFaker = new Faker<UserProfile>()
                        ...
                        .RuleFor(c => c.ProfilePicture, f => new FormFile(new MemoryStream(new byte[0]), 0, 0, "ProfilePicture", "empty.png"))
                    ...
                    var categories = new Faker<Category>() 
                        ...
                        .RuleFor(c => c.CategoryImage, f => new FormFile(new MemoryStream(new byte[0]), 0, 0, "CategoryPicture", "empty.png"))
                    ...
                    return Results.Ok("Table succesfully seeded");
                }
                catch (Exception ex)
                {
